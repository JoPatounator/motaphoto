 ...
 * @see Walker
 */
class Ally_Walker_Nav_Menu extends Walker {
	/**
	...
	public function start_el( &$output, $data_object, $depth = 0, $args = null, $current_object_id = 0 ) {
		 ...
		 * @param int      $depth     Depth of menu item. Used for padding.
		 */
        $atts['aria-current'] = $menu_item->current ? 'page' : ''; // Ajout de la clé "current"
        ...
        //var_dump($menu_item); // Affichage des clés de la variable $menu_item afin de verifier la valeur de la clé "current" !!!!!!!!!!!!!!!!!!!!!!!!!!!
	}
