...
<div class="bloc-photo-liste">
    ...
    <div class="photo-hover">
        ...
        <a href="#" class="icon-fullscreen" data-img="<?php echo get_the_post_thumbnail_url(); ?>" aria-label="Afficher en plein écran">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Icon_fullscreen.png" alt="Plein écran">
            </a>
        </a>
    </div>
</div>
